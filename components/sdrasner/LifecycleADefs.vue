<template>
  <defs>
    ...
    <linearGradient id="linear-gradient-3" x1="284.14" y1="268.89" x2="284.14" y2="-17.96" gradientTransform="rotate(-63.6 387.21 177.67)"
      gradientUnits="userSpaceOnUse">
      <stop offset="0" stop-color="#1a1a1a" />
      <stop offset="0.38" stop-color="#0f0f0f" />
      <stop offset="1" stop-color="#010101" />
    </linearGradient>
    <linearGradient id="linear-gradient-4" x1="283.51" y1="241.53" x2="283.51" y2="9.32" gradientTransform="rotate(-63.6 387.21 177.67)"
      gradientUnits="userSpaceOnUse">
    ...
    <clipPath id="clip-path" transform="translate(0 58)">
      <path d="M331.1,203.9c-28.6-16.5-58.1-16.5-86.7,0h0c-14.3,8.3-21.4,16.6-21.4,25s7.1,16.8,21.4,25c28.6,16.5,58.1,16.5,86.7,0,14.3-8.3,21.4-16.6,21.4-25S345.4,212.1,331.1,203.9Z"
        fill="none" />
    </clipPath>
    ...
    <radialGradient id="radial-gradient-2" cx="307.16" cy="4167.95" r="1.19" gradientTransform="translate(-3191.2 2545.3) rotate(-120)"
      gradientUnits="userSpaceOnUse">
    ...
    <radialGradient id="radial-gradient-5" cx="1477.17" cy="2109.99" r="1.19" gradientTransform="matrix(0.5, -0.87, -0.87, -0.5, 1361.25, 2545.34)"
    ...
    <radialGradient id="radial-gradient-20" cx="290.09" cy="206.75" r="72.73" gradientTransform="translate(8.8 4) scale(0.96 1)"
      gradientUnits="userSpaceOnUse">
    ...
    <clipPath id="clip-path-20" transform="translate(0 4)">
      <path d="M322.3,217c-23.5-13.5-47.7-13.5-71.1,0h0c-11.7,6.8-17.6,13.7-17.6,20.5s5.9,13.8,17.6,20.5c23.5,13.5,47.7,13.5,71.1,0,11.7-6.8,17.6-13.7,17.6-20.5S334.1,223.8,322.3,217Z"
        fill="none" />
    </clipPath>
    <radialGradient id="radial-gradient-21" cx="327.24" cy="187.43" r="71.25" gradientTransform="translate(-1.3 64.3) scale(1 0.76)"
      gradientUnits="userSpaceOnUse">
    ...
    <linearGradient id="linear-gradient-24" x1="349.41" y1="167.91" x2="366.44" y2="197.41" gradientTransform="translate(27.6 -45.9) rotate(7.6)"
      gradientUnits="userSpaceOnUse">
      <stop offset="0" stop-color="#fed900" />
      <stop offset="0.4" stop-color="#fcc30b" />
      <stop offset="1" stop-color="#faa51a" />
    </linearGradient>
    <radialGradient id="radial-gradient-22" cx="338.27" cy="169.03" r="44.52" gradientTransform="translate(27.6 -45.9) rotate(7.6)"
      gradientUnits="userSpaceOnUse">
    ...
    <radialGradient id="radial-gradient-23" cx="338.97" cy="179.5" r="41.33" gradientTransform="translate(27.6 -45.9) rotate(7.6)"
      gradientUnits="userSpaceOnUse">
