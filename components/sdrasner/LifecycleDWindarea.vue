<template>
  <g id="wind">
    <g>
      ...
      />
      <g>
        <path d="M322.8,216.4c-26.4-15.2-53.6-15.2-79.9,0h0c-13.2,7.6-19.8,15.3-19.8,23.1s6.6,15.5,19.8,23.1c26.4,15.2,53.6,15.2,79.9,0,13.2-7.6,19.8-15.3,19.8-23.1S335.9,224,322.8,216.4Z"
          transform="translate(28.3 4)" fill="#f99b1c" />
        <path d="M322.8,251.1c-26.4,15.2-53.6,15.2-79.9,0-13.2-7.6-19.8-15.3-19.8-23.1v11.5c0,7.7,6.6,15.5,19.8,23.1,26.4,15.2,53.6,15.2,79.9,0,13.2-7.6,19.8-15.3,19.8-23.1V228C342.5,235.7,335.9,243.4,322.8,251.1Z"
          transform="translate(28.3 4)" fill="url(#linear-gradient-15)" />
        <path d="M322.8,204.9c-26.4-15.2-53.6-15.2-79.9,0h0c-13.2,7.6-19.8,15.3-19.8,23.1s6.6,15.5,19.8,23.1c26.4,15.2,53.6,15.2,79.9,0,13.2-7.6,19.8-15.3,19.8-23.1S335.9,212.5,322.8,204.9Z"
          transform="translate(28.3 4)" fill="#abc738" />
      </g>
      ...
      <path d="M331.3,243l-65.7,1,3.1-14.3V208.3l32.9-11.3s19.3,2.6,37.8,21.3l-53.7,2-9,10.3,64.8,2.5Z" transform="translate(28.3 4)"
        fill="url(#linear-gradient-17)" />
      <g class="wind-stand">
        <path d="M268.6,240.2c-5,0-9.1-2.3-9.1-5.2h0c0-2.9,4.1-5.2,9.1-5.2s9.1,2.3,9.1,5.2h0C277.6,237.8,273.6,240.2,268.6,240.2Z"
          transform="translate(28.3 4)" fill="#272626" />
        <g>
          <path d="M268.6,240.2c-5,0-9.1-2.3-9.1-5.2v4c0,2.9,4.1,5.2,9.1,5.2s9.1-2.3,9.1-5.2v-4C277.6,237.8,273.6,240.2,268.6,240.2Z"
            transform="translate(28.3 4)" fill="url(#linear-gradient-10)" />
          <path d="M268.6,214.5c-1.6,0-2.9-.8-2.9-1.7v22.1c0,.9,1.3,1.7,2.9,1.7s2.9-.8,2.9-1.7V212.8C271.5,213.7,270.2,214.5,268.6,214.5Z"
            transform="translate(28.3 4)" fill="url(#linear-gradient-11)" />
        </g>
      </g>
      <g class="windbox">
        <g>
          ...
          <path d="M289.1,205.8h0a30.6,30.6,0,0,0-8.5-14.6,17.6,17.6,0,0,0-7.3-4.4l-.6-.2a7.8,7.8,0,0,0-4.1.1h-.2l-1,.4h0c-3.3,1.9-4.7,6.9-3.2,13.4,2.2,9.2,9.5,17.8,16.4,19.2a7.3,7.3,0,0,0,5.2-.6h0l.9-.6a8,8,0,0,0,2.5-4.1A17.5,17.5,0,0,0,289.1,205.8Z"
            transform="translate(28.3 4)" fill="#f0f7f7" />
          ...
          <path d="M313.9,188.1c-1.5-6.1-6.3-11.8-10.9-12.7a5.2,5.2,0,0,0-2.6.1h-.2l-7.8,2.8a5.9,5.9,0,0,1,3-.1l1.9.6c4.5,2,8.9,7.7,10.3,13.7a14.8,14.8,0,0,1,.4,4.9,7,7,0,0,1-1.9,4.5l6.3-5.4h.1C314.2,194.8,314.8,191.8,313.9,188.1Z"
            transform="translate(28.3 4)" fill="url(#linear-gradient-7)" />
        </g>
        <g>
          <path d="M307.7,192.5c-1.4-6-5.8-11.7-10.3-13.7l-1.9-.6a5.9,5.9,0,0,0-3,.1h-.1l-7.8,2.8a6.5,6.5,0,0,1,3.4-.1l1.4.4c5.2,2,10.5,8.5,12.2,15.5a15.6,15.6,0,0,1,.3,6.1,7.2,7.2,0,0,1-2.2,4.4h0l6.6-5.6h0a7,7,0,0,0,1.9-4.5A14.8,14.8,0,0,0,307.7,192.5Z"
        ...
        <path d="M266.5,201c1.8,7.5,7.8,14.6,13.4,15.8a6,6,0,0,0,4.3-.5h0c2.7-1.6,3.9-5.7,2.6-11-1.8-7.5-7.8-14.6-13.4-15.8a6,6,0,0,0-4.3.5h0C266.4,191.6,265.2,195.7,266.5,201Z"
          transform="translate(28.3 4)" fill="url(#linear-gradient-9)" />
        ...
        />
        <path d="M264.6,207.1a.3.3,0,0,1-.3-.3V195.9a.3.3,0,1,1,.7,0v10.9A.3.3,0,0,1,264.6,207.1Z" transform="translate(28.3 4)"
          fill="#010101" />
    ...
    <g id="flower1" fill-rule="evenodd">
      <path class="leaf1" d="M293.6,219.8c-2.9,14.9-.7,20.2.4,32.6.1.9.3,2.6-.4,3.2v-.8C292,240.6,287.6,236.4,293.6,219.8Z" transform="translate(28.3 4)"
        fill="#688338" />
      <path class="leaf2" d="M315.7,236.8c-9.8-.1-20.8,5.4-21.7,15.5-.1.9,0,2.6-.1,2.9s1.6-9.3,6.5-13S310.7,239.9,315.7,236.8Z"
        transform="translate(28.3 4)" fill="#50672e" />
      <path class="leaf3" d="M300.9,224.3c-3.5,3.2-4.3,8.7-4.2,13s.2,5.8-.7,8.4a61.7,61.7,0,0,0-1.4,6.1,8.2,8.2,0,0,0-.2,2.9l-.4.3a7.5,7.5,0,0,1,.2-3.3,62.3,62.3,0,0,1,1.4-6.2c.9-2.5.8-5.3.8-8.2-.1-4.4.7-9.6,4.3-13.3Z"
        transform="translate(28.3 4)" fill="#9f5f30" />
      <g id="petals-2" data-name="petals">
        <path class="petal1" d="M301.1,223.9a2.8,2.8,0,0,0-.1,2.1,4.4,4.4,0,0,1-4.2,0c-.5-.3-.5-.2,0-.6S299.2,223.4,301.1,223.9Z"
          transform="translate(28.3 4)" fill="#ffcc04" />
        <path class="petal2" d="M300.5,225.2a3.7,3.7,0,0,0,2.4.8,3.6,3.6,0,0,1-1.5,3.7c-.8.6-1,.8-1.3,0S299.3,227,300.5,225.2Z" transform="translate(28.3 4)"
          fill="#ffcc04" />
        <path d="M302,225.8a2.4,2.4,0,0,0,1.8-.6c1.1.9,1.4,1.7,1.3,3.4s0,.5-.6.2C302.3,227.5,302.3,227.8,302,225.8Z" transform="translate(28.3 4)"
          fill="#fcdb54" />
        <path d="M301.3,224.7c.2-.7.4-.9,1-1.3s-1.7-1.3-3.6-1.6-.6-.1-.3.4S299.1,224.1,301.3,224.7Z" transform="translate(28.3 4)"
          fill="#fcdb54" />
        <path d="M301.5,223.9a1.2,1.2,0,0,1,1.2,0,3.7,3.7,0,0,0-.3-3c-.2-.5-.2-.4-.4,0S301,222.3,301.5,223.9Z" transform="translate(28.3 4)"
          fill="#ffcc04" />
        ...
        <path d="M303.4,221.7a1.1,1.1,0,0,1,.3,1c0,.2,0,.1.2.2a.4.4,0,0,1,.2.5c0,.2,0,.1.1.3s-.1.3-.2.4-.2.1,0,.3a.7.7,0,0,1,.1.7c-.1.3,0,.3.3.4s.6.5-.2.3-1.1.3-1.7.5a1.3,1.3,0,0,1-1.5-1.6c.1-.6,1.6-1,2.2-2.3v-.4C303.2,221.4,303.2,221.4,303.4,221.7Z"
          transform="translate(28.3 4)" fill="#ffea8d" />
      </g>
      <path class="leaf3" d="M296.4,220a329.2,329.2,0,0,1-2,34.6l-.4.6C293,250.5,293.8,240.2,296.4,220Z" transform="translate(28.3 4)"
        fill="#699c41" />
    </g>
    ...
    <g id="flower2" fill-rule="evenodd">
      <path class="leaf4" d="M250.1,198.3c-10.9-.8-11.7,8.6-12.7,18.2-.4,3.5.3,10.9.5,14.4C241.5,214.4,238.7,205.8,250.1,198.3Z"
        transform="translate(28.3 4)" fill="#89bb40" />
      <path class="leaf5" d="M249.9,203.1c-5.7,9-8.6,9.8-10.5,19.6-.7,3.6-1.5,4.6-1.6,8.2C243.3,214.3,248.6,217.8,249.9,203.1Z"
        transform="translate(28.3 4)" fill="#659a41" />
      <path class="petal3" d="M249.3,207.2c2.4.5.6,4.5-1,6.4s-3.9,3.6-5.7,3.2-.6-2.3-.6-3.7.9-2.4,1.7-3.5.9-.8,1.8-1.4A5.7,5.7,0,0,1,249.3,207.2Z"
        transform="translate(28.3 4)" fill="#edc21c" />
      <path d="M246.6,205.7c-1.3-2-4.1,1.2-5.3,3.4s-1.8,5-.8,6.6,2.2-.3,3.5-.8,1.8-1.8,2.5-3a5.1,5.1,0,0,0,.6-2.2A6.1,6.1,0,0,0,246.6,205.7Z"
        transform="translate(28.3 4)" fill="#edc21c" />
      <path d="M248.4,207c2.2,1.3.5,4.7-1.2,6.8s-3.1,3-4.7,3-2.2-1.9-2.2-3.3,1.1-2.4,2.1-3.6S246.5,205.8,248.4,207Z" transform="translate(28.3 4)"
        fill="#f8d335" />
      <path d="M241.6,216.8a14.9,14.9,0,0,0-1.3,3.1,42.7,42.7,0,0,0-1.3,4.7c-.1.5-.4,2.6-.5,4.2s-.3,1.7-.3,1.8l-.3.2a5.6,5.6,0,0,1,0-2c.1-1.6.5-3.7.5-4.2a43.2,43.2,0,0,1,1.3-4.8,15.1,15.1,0,0,1,1.3-3.2Z"
        transform="translate(28.3 4)" fill="#a46127" />
    </g>
    <g id="hat">
      <ellipse cx="-14.3" cy="215.8" rx="8.4" ry="14" transform="rotate(-85.1 1.96 202.33)" fill="#f4d27a" />
      <path d="M-15.2,210.8h.7l2-.8,3-1,1.3-.5a22.2,22.2,0,0,0-5.4-1.1c-7.7-.7-14.3,2.6-14.7,7.2a6.6,6.6,0,0,0,2.4,5.3,9.4,9.4,0,0,1,2.3-6.7,8.4,8.4,0,0,1,6-3.1A3.7,3.7,0,0,1-15.2,210.8Z"
        transform="translate(28.3 4)" fill="#fee9ab" />
      <path d="M-20,215.3a12.2,12.2,0,0,0,6.5,1.4,10,10,0,0,0,2.9-.7,17.7,17.7,0,0,1,3.4-1.4h.1a11.7,11.7,0,0,0,.4-3.1c0-5.2-3.4-7.5-7.4-7.5s-7.2,2.3-7.2,7.5a11.6,11.6,0,0,0,.5,3.5Z"
        transform="translate(28.3 4)" fill="#f4d27a" />
      <path d="M-18.9,209.4l3-2.7a11.8,11.8,0,0,1,2.6-2h-.9c-3.6,0-6.5,2.1-6.5,6.7,0,.2,0,.3,0,.5A7.6,7.6,0,0,1-18.9,209.4Z" transform="translate(28.3 4)"
        fill="#fee9ab" />
      <path d="M-7.8,211.3h-.9l-1.5.3h-.7l-.6.3-.4.3-.4.3a13.5,13.5,0,0,0-1.9,2.6,4.1,4.1,0,0,1-1,1.1,13.1,13.1,0,0,0,3,.2l2.2-.4a17.8,17.8,0,0,1,2.7-.8H-7a4.6,4.6,0,0,0,.3-1.7,3.5,3.5,0,0,0-.8-2.4Z"
        transform="translate(28.3 4)" fill="#d4b163" opacity="0.32" />
      <path d="M-14,216c-3.3,0-6.2-1-7.2-2.3v.2c0,1.9,3.2,3.5,7.2,3.5s7.2-1.6,7.2-3.5v-.2C-7.9,215.1-10.7,216-14,216Z" transform="translate(28.3 4)"
        fill="#ee302d" />
    </g>
  </g>
</template>
  ...
  mounted() {
    ...
    tl.to(
      ...
      1.5,
      {
        attr: {
          d:
            "M321.6,240.6c-18.9-5.4-28.7-.7-27.6,11.7.1.9.3,2.6-.4,3.2v-.8C292,240.6,299.9,239.1,321.6,240.6Z"
        },
        repeat: 2,
        yoyo: true,
        ease: easeConfig
    ...
    tl.to(
      ...
      1.5,
      {
        attr: {
          d:
            "M259.8,205.8c-10.9-.8-15.1,2.6-20.4,10.7-1.9,2.9-1.7,10.9-1.5,14.5C241.5,214.4,248.3,213.3,259.8,205.8Z"
        },
        repeat: 2,
        yoyo: true,
        ease: easeConfig
    ...
    tl.to(
      ...
      1.5,
      {
        attr: {
          d:
            "M257.7,211.1c-7.7,1.2-16.4,1.7-18.2,11.6-.7,3.6-1.5,4.6-1.6,8.2C243.3,214.3,249.8,218,257.7,211.1Z"
        },
        repeat: 2,
        yoyo: true,
        ease: easeConfig
